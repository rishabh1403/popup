var allSvg = {
	...
	$closeSvg: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" style="width:10px;height:10px;" viewBox="0 0 21.9 21.9" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 21.9 21.9">' +
		'<path d="M14.1,11.3c-0.2-0.2-0.2-0.5,0-0.7l7.5-7.5c0.2-0.2,0.3-0.5,0.3-0.7s-0.1-0.5-0.3-0.7l-1.4-1.4C20,0.1,19.7,0,19.5,0  c-0.3,0-0.5,0.1-0.7,0.3l-7.5,7.5c-0.2,0.2-0.5,0.2-0.7,0L3.1,0.3C2.9,0.1,2.6,0,2.4,0S1.9,0.1,1.7,0.3L0.3,1.7C0.1,1.9,0,2.2,0,2.4  s0.1,0.5,0.3,0.7l7.5,7.5c0.2,0.2,0.2,0.5,0,0.7l-7.5,7.5C0.1,19,0,19.3,0,19.5s0.1,0.5,0.3,0.7l1.4,1.4c0.2,0.2,0.5,0.3,0.7,0.3  s0.5-0.1,0.7-0.3l7.5-7.5c0.2-0.2,0.5-0.2,0.7,0l7.5,7.5c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l1.4-1.4c0.2-0.2,0.3-0.5,0.3-0.7  s-0.1-0.5-0.3-0.7L14.1,11.3z"/>' +
		'</svg>',
	$warningSvg: '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
		'viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;width:30px;height:30px;" xml:space="preserve"><circle style="fill:#EFCE4A;" cx="25" cy="25" r="25"/><line style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;" x1="25" y1="10" x2="25" y2="32"/><line style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;" x1="25" y1="37" x2="25" y2="39"/><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>',

	$infoSvg: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
		'viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;width:30px;height:30px;" xml:space="preserve">' +
		...
		'<g><path style="fill:#FFFFFF;" d="M291.31,397.241h-0.009c-4.875,0-8.828-3.953-8.828-8.828V203.034c0-4.875,3.953-8.828,8.828-8.828' +
		...
		'z"/>' +
		'<circle style="fill:#FFFFFF;" cx="256" cy="123.586" r="26.483"/></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>',

	$errorSvg: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
		' viewBox="0 0 507.2 507.2" style="enable-background:new 0 0 507.2 507.2;width:30px;height:30px;" xml:space="preserve">' +
		...
		'c-11.2,11.2-30.4,11.2-41.6,0l-22.4-22.4c-11.2-11.2-11.2-30.4,0-41.6L309.6,133.6z"/><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>'
...
var globalObj = {
	...
	setHeight: function () {
		this.$append.css('height', this.settingObj.height);
	},
	...
	setType: function () {
		if (this.settingObj.type == 'success') {
			this.$append.css('background-color', this.successColor);
		}
		if (this.settingObj.type == 'error') {
			this.$append.css('background-color', this.errorColor);
		}
		if (this.settingObj.type == 'info') {
			this.$append.css('background-color', this.infoColor);
		}
		if (this.settingObj.type == 'warning') {
			this.$append.css('background-color', this.warningColor);
		}
	},
	addStyles: function () {
		this.setWidth();
	...
	animate: function () {
		...
		if (!this.settingObj.sticky) this.hidePopup();
	},
	...
	attachDefaultValues: function (settingObj) {
		...
		if (!settingObj.height) settingObj.height = 'inherit';
		else settingObj.height = settingObj.height + "px";
